<?php
// register.php revised version with your design + backend integration
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Sitaranet - Register</title>
  ...
  <body class="bg-gray-100 text-gray-800 font-sans min-h-screen">
    ...
    <section class="container mx-auto py-12">
      <h1 class="text-3xl font-bold mb-4 pt-10">Register</h1>

      <!-- UPDATED: action menuju backend register -->

      <form action="../backend/auth/register.php" method="POST" class="bg-white p-6 rounded-lg shadow-lg">
